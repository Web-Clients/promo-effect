const messages: Record<string, Record<string, string>> = {
  ro: {
    ...
    'validation.cfrShippingLineRequired': 'Pentru CFR selectați linia maritimă',
  ...
  ru: {
    ...
    'validation.cfrShippingLineRequired': 'Для CFR выберите судоходную линию',
  ...
  en: {
    ...
    'validation.cfrShippingLineRequired': 'For CFR please select a shipping line',
