        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-20 mb-32">
          <div>
            ...
            <p className="mt-8 text-neutral-600 text-sm font-medium leading-relaxed italic">
              Lider în digitalizarea importurilor strategice din Asia. Transparență totală,
              expertiză vamală și eficiență operațională garantată.
            </p>
          </div>
          <div>
            <h5 className="text-[10px] font-black text-neutral-400 uppercase tracking-widest mb-10">
              Servicii
            </h5>
            <ul className="space-y-4 text-sm font-bold text-neutral-600 uppercase tracking-widest">
              {[
                ...
                <li key={s.name} className="hover:text-primary-500 transition-colors">
