      ...
      <div className="min-h-screen bg-gradient-to-br from-primary-800 via-primary-700 to-primary-900 flex items-center justify-center p-4">
        <div className="w-full max-w-md bg-white dark:bg-neutral-900 rounded-2xl shadow-xl p-8 text-center">
          ...
          <p className="text-neutral-600 dark:text-neutral-400 mb-6">
            Am trimis un link de verificare la adresa <span className="font-medium text-primary-700 dark:text-primary-400">{formData.email}</span>.
            <br />
            Te rugăm să verifici inbox-ul și să confirmi adresa de email înainte de a te autentifica.
          </p>

          <div className="bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800 rounded-lg p-4 mb-6">
            <p className="text-sm text-amber-800 dark:text-amber-300">
              <strong>Notă:</strong> Verifică și folderul Spam dacă nu găsești email-ul.
            </p>
          </div>
