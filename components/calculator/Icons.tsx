...
export const CalculatorIcon = ({ large }: { large?: boolean }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    className={`${large ? 'h-16 w-16' : 'h-6 w-6'}`}
    fill="none"
    viewBox="0 0 24 24"
    stroke="currentColor"
  >
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1} d="M9 7h6m0 0v6m0-6L9 13" />
    <path
